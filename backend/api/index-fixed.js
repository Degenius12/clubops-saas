// ClubOps SaaS - FIXED Vercel Serverless API with /api prefix
// Premium club management backend with corrected routing
...
// ============= AUTHENTICATION ROUTES (FIXED WITH /api PREFIX) =============
...
// ============= DANCER MANAGEMENT ROUTES (FIXED WITH /api PREFIX) =============
...
// ============= DASHBOARD ROUTES (FIXED WITH /api PREFIX) =============
...
// ============= VIP ROOM MANAGEMENT (ALREADY HAS /api PREFIX) =============
...
// ============= DJ QUEUE MANAGEMENT (ALREADY HAS /api PREFIX) =============
...
// ============= FINANCIAL ROUTES (FIXED WITH /api PREFIX) =============
...
app.get('/health', (req, res) => {
  res.json({ 
    status: 'ok', 
    message: 'ClubOps Complete API is running - ROUTES FIXED!',
...
app.get('/', (req, res) => {
  res.json({ 
    message: 'ClubOps SaaS - API Routes FIXED!', 
    version: '2.1.0-FIXED',
    fix: 'All routes now have /api prefix to match frontend expectations',
    features: [
